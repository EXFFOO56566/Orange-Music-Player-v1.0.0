package com.tochycomputerservices.orangemusic.fragments
...
import com.tochycomputerservices.orangemusic.adapters.AllSongsAdapter
import com.tochycomputerservices.orangemusic.R
import com.tochycomputerservices.orangemusic.adapters.RecentTracksAdapter
...
import com.tochycomputerservices.orangemusic.uicomponents.CustomDialog
import com.tochycomputerservices.orangemusic.database.allSongs.SongEntity
import com.tochycomputerservices.orangemusic.uicomponents.AddToPlaylist
import com.tochycomputerservices.orangemusic.uicomponents.BounceEdgeEffectFactory
import com.tochycomputerservices.orangemusic.utils.Utility
...
class HomeFragment : Fragment() {
    ...
    lateinit var viewAllBtn: TextView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewAllBtn.setOnClickListener {
            val fragSongsQueueFragment = SongsQueueFragment()
            val transaction: FragmentTransaction = fragmentManager?.beginTransaction()!!
            transaction.replace(R.id.containerList, fragSongsQueueFragment)
            transaction.commit()
        }
            ...
            R.id.ctx_add_to_playlist -> {
                ...
                try {
                    if(hasCreatedPlaylist)
                        ...
                        Toast.makeText(activity as Context,"This feature is under development",Toast.LENGTH_SHORT).show()
                } catch (e: Exception) {
                    e.printStackTrace()
                }
