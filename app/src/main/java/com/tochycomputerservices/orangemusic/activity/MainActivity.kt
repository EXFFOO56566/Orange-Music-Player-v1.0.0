package com.tochycomputerservices.orangemusic.activity
...
import com.tochycomputerservices.orangemusic.fragments.*
import com.tochycomputerservices.orangemusic.interfaces.Playable
import com.tochycomputerservices.orangemusic.services.OnClearFromRecentService
import com.tochycomputerservices.orangemusic.uicomponents.RepeatTriStateButton
import com.tochycomputerservices.orangemusic.viewmodel.allSongs.AllSongsViewModel
import com.tochycomputerservices.orangemusic.viewmodel.allSongs.AllSongsViewModelFactory
import com.tochycomputerservices.orangemusic.viewmodel.mediaControl.MediaControlViewModel
import com.tochycomputerservices.orangemusic.viewmodel.playlists.PlaylistViewModel
import com.tochycomputerservices.orangemusic.viewmodel.playlists.PlaylistViewModelFactory
import com.tochycomputerservices.orangemusic.viewmodel.recentSongs.RecentSongsViewModel
import com.tochycomputerservices.orangemusic.viewmodel.recentSongs.RecentSongsViewModelFactory
...
class MainActivity : AppCompatActivity(), Playable {
    ...
    lateinit var bSheet: RelativeLayout
    lateinit var bSheetExpanded: LinearLayout
    lateinit var sharedPreferences: SharedPreferences

    private var mInterstitialAd: InterstitialAd? = null

    /**copywright 2021 @ tochy Now Playing Controls*/
    ...
    lateinit var bSheetCollapsedSong: TextView
    lateinit var bSheetCollapsedArtist: TextView
    lateinit var collapsedMusicControl: ToggleButton
    ...
    lateinit var btnPrevControl: ImageView
    lateinit var btnPlayPauseControl: ToggleButton
    lateinit var btnNextControl: ImageView
    ...
    val MediaPlayer.seconds: Int
        get() = try {
            Log.e("Refresh", "MediaPlayer.seconds is called"); this.duration / 1000
        } catch (e: Exception) {
            Log.e("Refresh", "Media player was null for MediaPlayer.seconds"); 0
        }
    val MediaPlayer.currentSeconds: Int
        get() = try {
            Log.e("Refresh", "MediaPlayer.currentSeconds is called"); this.currentPosition / 1000
        } catch (e: Exception) {
            Log.e("Refresh", "Media player was null for MediaPlayer.currentSeconds"); 0
        }
    ...
    private val globalIsPlayingSongObserver = androidx.lifecycle.Observer<Boolean> {
        ...
        collapsedMusicControl.isChecked = it
        playPauseMedia(it)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bSheet = findViewById(R.id.b_sheet_Collapsed)
        bSheetExpanded = findViewById(R.id.b_sheet_Expanded)



        bSheetCollapsedSong = findViewById(R.id.b_sheet_Collapsed_Song)
        bSheetCollapsedArtist = findViewById(R.id.b_sheet_Collapsed_Artist)
        collapsedMusicControl = findViewById(R.id.b_sheet_CollapsedMusicControl)
        ...
        collapsedMusicControl.setOnCheckedChangeListener(
    ...
    fun LoadAd() {
        ...
        InterstitialAd.load(
            this,
            resources.getString(R.string.interstitial_admob),
            adRequest,
    ...
    private suspend fun setUpCollapsedBottomSheetUI(songEntity: SongEntity) {
        withContext(Dispatchers.Main) {
            bSheetCollapsedSong.text = songEntity.songName
            bSheetCollapsedArtist.text = songEntity.artistName
    ...
    private suspend fun setUpExpandedBottomSheetUI(songEntity: SongEntity) {
        withContext(Dispatchers.Main) {
            ...
            try {
                ...
                Picasso.with(this@MainActivity).load(actualArtUri).error(R.drawable.d7)
                    .into(musicCoverPic)


            } catch (e: java.lang.Exception) {
                musicCoverPic.setImageResource(R.drawable.d7)
            }
        }
            ...
            override fun onStateChanged(bottomSheet: View, newState: Int) {
                ...
                when (newState) {
                    BottomSheetBehavior.STATE_COLLAPSED -> {
                        ...
                        bSheet.visibility = View.VISIBLE
                        bSheetExpanded.visibility = View.GONE
                    }
                    BottomSheetBehavior.STATE_EXPANDED -> {

                        bottomNavigationView.visibility = View.GONE
                        bSheet.visibility = View.GONE
                        bSheetExpanded.visibility = View.VISIBLE
                    }
    ...
    private fun refreshDatabases() {
        ...
        for (song in deletedSongs) {
            ...
            mRecentSongsViewModel.deleteRecentSong(
                RecentSongEntity(
                    song.songId,
                    song.albumId,
                    getLocalTime()
    ...
    companion object {
        ...
        private const val ACTION_UPDATE_NOTIFICATION =
            "com.projects.SangeetMusicPlayer.ACTION_MUSIC_NOTIFICATION"
        const val NOTIFICATION_ID = 0
        const val ACTION_PREVIOUS = "com.projects.SangeetMusicPlayer.ACTION_PREVIOUS"
        const val ACTION_PLAY_PAUSE = "com.projects.SangeetMusicPlayer.ACTION_PLAY"
        const val ACTION_NEXT = "com.projects.SangeetMusicPlayer.ACTION_NEXT"
    }
